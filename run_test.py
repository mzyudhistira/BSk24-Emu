...
def run(run_param):
    ...
    # Sampling the varian
    varian_sample = run_param[:1]
    print(f"aaaaaaaaaa: {varian_sample}")
    ...
    data_train, data_test, data_val = split_input(input_data, 1, 0, 0)
    ...
    # """
    # # Training the model
    # training_label = f"EXT 24 run custom loss2, code: {run_param[0]}"
